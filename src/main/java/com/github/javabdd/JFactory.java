...
public class JFactory extends BDDFactoryIntImpl {
    ...
    int bdd_saturationForward(int states, int[] relations, int[] vars, int instance) {
        ...
        // We may also apply the OR operation while computing 'saturationForward'.
        applyop = bddop_or;
    ...
    int bdd_saturationBackward(int states, int[] relations, int[] vars, int instance) {
        ...
        // We may also apply the OR operation while computing 'saturationBackward'.
        applyop = bddop_or;
    ...
    int bdd_boundedSaturationBackward(int states, int bound, int[] relations, int[] vars, int instance) {
        ...
        // We may also apply the AND and OR operation while computing 'boundedSaturationBackward'.
        // Let's configure the OR operation as the default.
        applyop = bddop_or;
